...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'NanoTransformer.GPTText2Text': { 'NanoTransformer.GPTText2Text.AttentionHead': ( 'gpttext2text.html#attentionhead',
            ...
            'NanoTransformer.RoPE': { 'NanoTransformer.RoPE.Embedding': ('rope.html#embedding', 'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.Embedding.__init__': ( 'rope.html#embedding.__init__',
                                                                                   'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.Embedding.forward': ('rope.html#embedding.forward', 'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.MultiModal': ('rope.html#multimodal', 'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.MultiModal.__init__': ( 'rope.html#multimodal.__init__',
                                                                                    'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.MultiModal.forward': ( 'rope.html#multimodal.forward',
                                                                                   'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.RoPE': ('rope.html#rope', 'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.RoPE.__init__': ('rope.html#rope.__init__', 'NanoTransformer/RoPE.py'),
                                      'NanoTransformer.RoPE.RoPE.forward': ('rope.html#rope.forward', 'NanoTransformer/RoPE.py')},
